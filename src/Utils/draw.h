...
namespace Draw {
    ...
    void ImRect(ImVec2 a, ImVec2 b, ImColor color, float rounding = 0.0f, int rounding_corners_flags = ~0,
                float thickness = 1.0f);

    void ImRect(int x0, int y0, int x1, int y1, ImColor color, float rounding = 0.0f, int rounding_corners_flags = ~0,
                float thickness = 1.0f);

    void
    ImRectFilled(int x0, int y0, int x1, int y1, ImColor color, float rounding = 0.0f, int rounding_corners_flags = ~0);

    void ImRectFilled(ImVec2 a, ImVec2 b, ImColor color, float rounding = 0.0f, int rounding_corners_flags = ~0);

    void
    ImText(ImVec2 pos, ImColor color, const char *text_begin, const char *text_end = nullptr, float wrap_width = 0.0f,
