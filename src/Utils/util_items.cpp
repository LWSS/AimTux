...
namespace Util {
    namespace Items {
        ...
        const std::map<std::string, ItemDefinitionIndex> ItemNames = {
                ...
                {ItemDefinitionIndexMap.at(
                        i::WEAPON_KNIFE_GYPSY_JACKKNIFE).entityName,                   i::WEAPON_KNIFE_GYPSY_JACKKNIFE},
        ...
        std::string GetItemDisplayName(ItemDefinitionIndex index) {
            if (ItemDefinitionIndexMap.find(index) != ItemDefinitionIndexMap.end()) {
                if (ItemDefinitionIndexMap.find(index) != ItemDefinitionIndexMap.end() &&
                    index != ItemDefinitionIndex::INVALID)
        ...
        ItemDefinitionIndex GetItemIndex(const std::string itemName) {
            return Util::MapSearchOrDefault<std::string, ItemDefinitionIndex>(&ItemNames, Util::ToLower(itemName),
