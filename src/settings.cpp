...
void Settings::LoadDefaultsOrSave(std::string path)
{
	...
	for (auto i : Settings::Aimbot::weapons)
	{
        ...
        weaponSetting[XORSTR("DoAimAfterXShots")][XORSTR("Enabled")] = i.second.doAimAfterXShotsEnabled;
        ...
        weaponSetting[XORSTR("DoAimAfterXShots")][XORSTR("Amount")] = i.second.doAimAfterXShotsAmount;
...
void Settings::LoadConfig(std::string path)
{
	...
	for (Json::ValueIterator itr = settings[XORSTR("Aimbot")][XORSTR("weapons")].begin(); itr != settings[XORSTR("Aimbot")][XORSTR("weapons")].end(); itr++)
	{
		...
		AimbotWeapon_t weapon = {
                ...
                .doAimAfterXShotsEnabled = weaponSetting[XORSTR( "DoAimAfterXShots" )][XORSTR( "Enabled" )].asBool(),
                ...
                .doAimAfterXShotsAmount =  weaponSetting[XORSTR( "DoAimAfterXShots" )][XORSTR( "Amount" )].asFloat(),
