...
struct AimbotWeapon_t {
    struct Triggerbot_t {
        ...
        int lowBound = 5; // in ms
        int highBound = 100; // in ms
        int lastRoll;
    } Triggerbot{};
    ...
    bool operator==(const AimbotWeapon_t &another) const {
        for (int bone = (int) DesiredBones::BONE_PELVIS; bone <= (int) DesiredBones::BONE_RIGHT_SOLE; bone++) {
            ...
            return this->enabled == another.enabled &&
                   ...
                   this->Triggerbot.key == another.Triggerbot.key &&
                   this->Triggerbot.enabled == another.Triggerbot.enabled &&
                   this->Triggerbot.allies == another.Triggerbot.allies &&
                   this->Triggerbot.enemies == another.Triggerbot.enemies &&
                   this->Triggerbot.smokeCheck == another.Triggerbot.smokeCheck &&
                   this->Triggerbot.flashCheck == another.Triggerbot.flashCheck &&
                   this->Triggerbot.head == another.Triggerbot.head &&
                   this->Triggerbot.chest == another.Triggerbot.chest &&
                   this->Triggerbot.stomach == another.Triggerbot.stomach &&
                   this->Triggerbot.arms == another.Triggerbot.arms &&
                   this->Triggerbot.legs == another.Triggerbot.legs &&
                   this->Triggerbot.randomDelay == another.Triggerbot.randomDelay &&
                   this->Triggerbot.lowBound == another.Triggerbot.lowBound &&
                   this->Triggerbot.highBound == another.Triggerbot.highBound &&
                   this->Triggerbot.lastRoll == another.Triggerbot.lastRoll;
        }
        return false;
    }
