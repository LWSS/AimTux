...
namespace panorama {
    ...
    public:
        ...
        virtual void
        CreateTextLayout(char const *, char const *, float, float, panorama::EFontWeight, panorama::EFontStyle,
                         panorama::ETextAlign, bool, bool, int, float, float) = 0;

        virtual void
        CreateTextLayout(wchar_t const *, char const *, float, float, panorama::EFontWeight, panorama::EFontStyle,
                         panorama::ETextAlign, bool, bool, int, float, float) = 0;
        ...
        virtual void
        RegisterForPanelDestroyed();//CUtlDelegate<void ()(panorama::IUIPanel const*,panorama::IUIPanel*)>) = 0;
        virtual void
        UnregisterForPanelDestroyed();//CUtlDelegate<void ()(panorama::IUIPanel const*,panorama::IUIPanel*)>) = 0;
        ...
        virtual void
        RegisterEventHandler(panorama::CPanoramaSymbol, panorama::IUIPanelClient *, CUtlAbstractDelegate) = 0;

        virtual void
        UnregisterEventHandler(panorama::CPanoramaSymbol, panorama::IUIPanelClient *, CUtlAbstractDelegate) = 0;
        ...
        virtual void
        RegisterPanelTypeEventHandler(panorama::CPanoramaSymbol, panorama::CPanoramaSymbol, CUtlAbstractDelegate,
                                      bool) = 0;
        ...
        virtual IUIPanel *GetLastDispatchedEventTargetPanel(
                void) = 0; // This function can fail sometimes and you need to check the result/call it later (YUCK!)
        ...
        virtual void
        SetCookieHeaderForNamedRemoteHost();//char const*,CUtlVector<CUtlString,CUtlMemory<CUtlString,int>> const&) = 0;
        virtual void
        SetCookieHeaderForRemoteHost();//char const*,CUtlVector<CUtlString,CUtlMemory<CUtlString,int>> const&) = 0;
        ...
        virtual void
        PulseActiveControllerHaptic();//panorama::IUIEngine::EHapticFeedbackPosition,panorama::IUIEngine::EHapticFeedbackStrength) = 0;
        ...
        virtual int
        RunScript(panorama::IUIPanel *panel, char const *entireJSCode, char const *pathToXMLContext, int, int,
                  bool alreadyCompiled) = 0;
        ...
        virtual void
        InitiateAsyncJSONWebAPIRequest();//EHTTPMethod,CUtlString,panorama::IUIPanel *,void *,panorama::CJSONWebAPIParams *,uint) = 0;
        virtual void InitiateAsyncJSONWebAPIRequest(
                int overloadMeme);//EHTTPMethod,CUtlString,CUtlDelegate<void ()(unsigned long long,KeyValues *,void *)>,void *,panorama::CJSONWebAPIParams *,uint) = 0;
        ...
        virtual void
        CreateInputEventFromSymbol(panorama::CPanoramaSymbol, panorama::IUIPanel *, panorama::EPanelEventSource_t,
                                   int) = 0;
        ...
        virtual PanelWrapper *CreatePanel(panorama::CPanoramaSymbol *panelType, char const *id,
                                          panorama::IUIPanel *createInThisParent) = 0; // paneltype (ex: Panel, Label), id (ex: <Label id="swag">)
        ...
        virtual const char *
        ResolveSymbol(unsigned short) = 0; // if you pass an invalid number into here, it can crash the program.
        ...
        virtual void
        GetWindowsForDebugger();//CUtlVector<panorama::IUIWindow *,CUtlMemory<panorama::IUIWindow *,int>> &) = 0;
