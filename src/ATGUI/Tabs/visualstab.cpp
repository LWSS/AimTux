...
void Visuals::RenderTab() {
    ...
    const char *Sounds[] = {"None", "SpongeBob", "Half life", "Half life 2", "Half life 3", "Half life 4",
    ...
    ImGui::Columns(2, nullptr, true);
    {
        ...
        ImGui::Combo(XORSTR("##BACKENDTYPE"), (int *) &Settings::ESP::backend, BackendTypes,
                     IM_ARRAYSIZE(BackendTypes));
    ...
    ImGui::Columns(2, nullptr, true);
    {
        ImGui::BeginChild(XORSTR("COL1"), ImVec2(0, 0), true);
        {
            ...
            ImGui::NextColumn();
            {
                ...
                ImGui::Combo(XORSTR("##SPRITETYPE"), (int *) &Settings::ESP::Sprite::type, SpriteTypes,
                             IM_ARRAYSIZE(SpriteTypes));
        ...
        ImGui::BeginChild(XORSTR("Chams"), ImVec2(0, 0), true);
        {
            ...
            ImGui::Columns(2, nullptr, true);
            {
                ...
                if (ImGui::BeginPopup(XORSTR("##MaterialConfigWindow"))) {
                    ...
                    ImGui::SliderFloat(XORSTR("##MONITORGAMMA"), &Settings::MaterialConfig::config.m_fMonitorGamma,
                                       0.1f, 12.0f,
                                       XORSTR("Gamma: %.3f"));
                    ImGui::SliderFloat(XORSTR("##GAMMATVRANGEMIN"),
                                       &Settings::MaterialConfig::config.m_fGammaTVRangeMin,
                                       0.1f, std::min(300.0f, Settings::MaterialConfig::config.m_fGammaTVRangeMax),
                                       XORSTR("TVRangeMin: %.3f"));
                    ImGui::SliderFloat(XORSTR("##GAMMATVRANGEMAX"),
                                       &Settings::MaterialConfig::config.m_fGammaTVRangeMax,
                                       Settings::MaterialConfig::config.m_fGammaTVRangeMin, 300.0f,
                                       XORSTR("TVRangeMax: %.3f"));
                    ImGui::SliderFloat(XORSTR("##GAMMATVEXPONENT"),
                                       &Settings::MaterialConfig::config.m_fGammaTVExponent,
                    ...
                    if (ImGui::BeginPopup(XORSTR("##MaterialConfigFlags"))) {
                        ...
                        static bool localFlags[] = {
                                ...
                                (Settings::MaterialConfig::config.m_Flags &
                                 MaterialSystem_Config_Flags_t::MATSYS_VIDCFG_FLAGS_NO_WAIT_FOR_VSYNC) !=
                                0, // ( 1 << 3 )
                                (Settings::MaterialConfig::config.m_Flags &
                    ...
                    ImGui::SliderInt(XORSTR("##NFULLBRIGHT"), (int *) &Settings::MaterialConfig::config.nFullbright, 0,
                                     3, XORSTR("nFullBright: %1.f"));
            ...
            ImGui::NextColumn();
            {
                ...
                ImGui::Combo(XORSTR("##WEAPONTYPE"), (int *) &Settings::ESP::Chams::Weapon::type, WeaponTypes,
                             IM_ARRAYSIZE(WeaponTypes));
                ...
                ImGui::SliderFloat(XORSTR("##NOFLASHAMOUNT"), &Settings::Noflash::value, 0, 255,
                                   XORSTR("Amount: %0.f"));
                ImGui::Combo(XORSTR("##SMOKETYPE"), (int *) &Settings::NoSmoke::type, SmokeTypes,
                             IM_ARRAYSIZE(SmokeTypes));
            ...
            ImGui::NextColumn();
            {
                ...
                ImGui::SliderInt(XORSTR("##HITMARKERGAP"), &Settings::ESP::Hitmarker::innerGap, 1, 16,
                                 XORSTR("Gap: %0.f"));
                ImGui::Combo(XORSTR ("Sounds##HITMARKERCOMBO"), (int *) &Settings::ESP::Hitmarker::Sounds::sound,
                             Sounds, IM_ARRAYSIZE(Sounds));
                ImGui::PopItemWidth();
            }
            ImGui::Columns(1);
            ImGui::Separator();
