...
void UI::ReloadWeaponSettings()
{
    ...
    doAimAfterXShotsEnabled = Settings::Aimbot::weapons.at(index).doAimAfterXShotsEnabled;
    ...
    doAimAfterXShotsValue = Settings::Aimbot::weapons.at(index).doAimAfterXShotsAmount;
