...
void Hooks::EmitSound2(void *thisptr, IRecipientFilter &filter, int iEntIndex, int iChannel, const char *pSoundEntry,
    ...
    soundVMT->GetOriginalMethod<EmitSound2Fn>(6)(thisptr, filter, iEntIndex, iChannel, pSoundEntry, nSoundEntryHash,
